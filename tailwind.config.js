...
/**
 * Plugin to add CSS variables for every color in the theme.
 */
...
module.exports = {
  darkMode: "class", // or ["class"] if you prefer that syntax
  content: [
  ...
  plugins: [
    ...
    // Plugin to add custom background image utilities using SVG data URIs.
